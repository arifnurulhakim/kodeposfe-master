<script setup>
    ...
    const jumlah = ref({});
    const jumlah_provinsi = ref(null);
    const jumlah_kabupaten = ref(null);
    const jumlah_kecamatan = ref(null);
    const jumlah_desa = ref(null);
    onMounted(() => {
        fetchData();
    });
    const fetchData = () => {
        axios
            ...
            .then((response) => {
                ...
                // Set jumlah_provinsi, jumlah_kabupaten, jumlah_kecamatan, jumlah_desa
                console.log(jumlah);
            })
            .catch((error) => {
                console.error(error);
    ...
    <div class="grid">
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">provinsi</span>
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">kabupaten</span>
                        <div class="text-900 font-medium text-xl">{{ jumlah.jumlah_kabupaten }}</div>
                    </div>
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">kecamatan</span>
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">desa</span>
