<script setup>
    ...
    const deleteSelectedKecamatans = async() => {
        try {
            ...
            await axios.delete(`/api/kecamatan`, {
                data: {
                    ids: selectedKecamatanIds
                }
            });
