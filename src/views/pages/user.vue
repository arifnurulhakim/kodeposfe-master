...
const isEditMode = ref(false);
    ...
    const getRoleLabel = (role) => {
        return role === 0 ? "Admin" : role === 1 ? "User" : "Unknown";
    };
    const getUserData = () => {
        axios
            .get('api/getAlluser')
...
<template #body="slotProps">
    ...
    {{ slotProps.data.name }}
                    ...
                    <Column field="instansi" header="instansi" :sortable="true" headerStyle="width:10%; min-width:10rem;">
<template #body="slotProps">
    <span class="p-column-title">instansi</span>
    {{ slotProps.data.instansi }}
</template>
                    </Column>
                  <Column field="role" header="Role" :sortable="true" headerStyle="width:10%; min-width:10rem;">
<template #body="slotProps">
...
<template #body="slotProps">
    ...
    <Button icon="pi pi-trash" class="p-button-rounded p-button-warning mt-2" @click="confirmDeleteUser(slotProps.data)" />
      ...
      <div class="field">
        ...
        <InputText id="name" v-model.trim="user.name" :required="isEditMode" autofocus :class="{ 'p-invalid': submitted && !user.name }" />
        <small class="p-invalid" v-if="submitted && !user.name">Name is required.</small>
      </div>
      <div class="field">
        <label for="instansi">Instansi</label>
        <InputText id="instansi" v-model.trim="user.instansi" :required="isEditMode" autofocus :class="{ 'p-invalid': submitted && !user.instansi}" />
        <small class="p-invalid" v-if="submitted && !user.instansi">Instansi is required.</small>
      </div>
      <div class="field">
      ...
      <div class="field">
        ...
        <InputText id="email" v-model.trim="user.email" :required="isEditMode" :class="{ 'p-invalid': submitted && !user.email }" />
        <small class="p-invalid" v-if="submitted && !user.email">Email is required.</small>
      </div>

      <div class="field">
        <label for="password">Password</label>
        <Password id="password" v-model.trim="user.password" :required="isEditMode" :class="{ 'p-invalid': submitted && !user.password }" />
