<script setup>
    ...
    const deleteSelectedKabupatens = async() => {
        try {
            ...
            await axios.delete(`/api/kabupaten`, {
                data: {
                    ids: selectedKabupatenIds
                }
            });
...
<template v-slot:end>
    <!-- <sFileUpload mode="basic" accept="image/*" :maxFileSize="1000000" label="Import" chooseLabel="Import" class="mr-2 inline-block" /> -->
