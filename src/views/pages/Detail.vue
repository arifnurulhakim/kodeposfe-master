    ...
    <div id="home" class="landing-wrapper overflow-hidden">
      ...
      <div id="highlights" class="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
        <div class="pb-6 rounded-b">
          <p class="my-6">Berikut ini adalah informasi untuk kelurahan {{ datakodepos.nama_kecamatan }}, {{ datakodepos.nama_kabupaten }}, {{ datakodepos.nama_provinsi }}, {{ datakodepos.kode_new }}
            <!-- -->:</p>
          <div class="block md:flex gap-6">
            <div class="w-auto max-w-[100%] overflow-x-auto mb-6">
              <center><img v-bind:src="'data:image/;base64,' + qrcode" style="width: 100px; height: 100px;" />
              ...
              <table class="w-full text-sm">
                <tbody>
                  <tr class="odd:bg-neutral-100">
                    <td class="font-bold px-6 py-3">Kode Pos</td>
                    <td class="px-6 py-3">{{ datakodepos.kode_new }}</td>
                  </tr>
                  <tr class="odd:bg-neutral-100">
                  ...
                  <tr class="odd:bg-neutral-100">
                    <td class="font-bold px-6 py-3">Kode Wilayah</td>
                    <td class="px-6 py-3">{{ datakodepos.kode_dagri }}</td>
                  </tr>
                  <tr class="odd:bg-neutral-100">
                    <td class="font-bold px-6 py-3">Kelurahan/Desa</td>
                    <td class="px-6 py-3">{{ datakodepos.nama_desa }}</td>
                  </tr>
                  <tr class="odd:bg-neutral-100">
              ...
              <table class="w-full text-sm">
                <tbody>
              <tr class="odd:bg-neutral-100">
                    <td class="font-bold px-6 py-3">Jumlah Penduduk</td>
                    <td class="px-6 py-3">{{ datakodepos.jumlah_penduduk }}</td>
                  </tr>
                  <tr class="odd:bg-neutral-100">
                    <td class="font-bold px-6 py-3">Jumlah Fasilitas Pendidikan</td>
                    <td class="px-6 py-3">{{ datakodepos.jumlah_fasilitas_pendidikan }}</td>
                  </tr>
                  <tr class="odd:bg-neutral-100">
                    <td class="font-bold px-6 py-3">Jumlah Fasilitas Ibadah</td>
                    <td class="px-6 py-3">{{ datakodepos.jumlah_fasilitas_ibadah }}</td>
                  </tr>
                  <tr class="odd:bg-neutral-100">
                    <td class="font-bold px-6 py-3">Jumlah Tempat Wisata</td>
                    <td class="px-6 py-3">{{ datakodepos.jumlah_tempat_wisata }}</td>
                  </tr>
                  <tr class="odd:bg-neutral-100">
                    <td class="font-bold px-6 py-3">Jumlah Industri Kecil</td>
                    <td class="px-6 py-3">{{ datakodepos.jumlah_industri_kecil }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <div class="flex justify-content-center col-12 lg:col-6 bg-purple-100 p-0 flex-order-1 lg:flex-order-0" style="border-radius: 8px; height: 400px;">
